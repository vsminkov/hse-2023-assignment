...
Домашнее задание можно будет выбрать либо из [списка](#task-list), либо предложить самому до **14 июня 2023**. В случае если предложен свой мини-проект, то он должен обязательно покрыть обязательную **`[о]`** и две дополнительные **`[д]`** темы:
